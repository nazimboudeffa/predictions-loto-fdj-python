...
data_folder = r'c:\Users\nboud\Documents\GitHub-My-Projects\predictions-loto-fdj-python\loto_super\data'

# Liste des fichiers à fusionner
files = [
    'nouveau_superloto.csv',
    'sloto.csv',
    'superloto_201907.csv',
    'superloto2017.csv'
]
...
output_file = os.path.join(data_folder, 'loto_super_all.csv')
merged_df.to_csv(output_file, sep=';', index=False, encoding='utf-8')

print(f"\nFichier fusionné créé: loto_super_all.csv")
