...
print("🔧 Nettoyage du fichier loto_normal_all.csv...\n")

# Charger les données
df = pd.read_csv('data/loto_normal_all.csv', sep=';', low_memory=False)
...
numeric_cols = [
    ...
    'boule_4_second_tirage', 'boule_5_second_tirage',
    'nombre_de_gagnant_au_rang_1_second_tirage', 'rapport_du_rang1_second_tirage',
    'nombre_de_gagnant_au_rang_2_second_tirage', 'rapport_du_rang2_second_tirage',
    'nombre_de_gagnant_au_rang_3_second_tirage', 'rapport_du_rang3_second_tirage',
    'nombre_de_gagnant_au_rang_4_second_tirage', 'rapport_du_rang4_second_tirage'
]
...
output_file = 'data/loto_normal_all_clean.csv'
df.to_csv(output_file, sep=';', index=False, encoding='utf-8')

print(f"\n✅ Fichier nettoyé créé : loto_normal_all_clean.csv")
...
print(df[['annee_numero_de_tirage', 'date_de_tirage', 'boule_1', 'boule_2', 'boule_3', 'boule_4', 'boule_5']].head())
